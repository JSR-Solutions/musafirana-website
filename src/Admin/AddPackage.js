...
function AddPackage() {
    ...
    const [costing, setCosting] = useState([{ title: "", cost: "0" }]);
    ...
    return <div>
        ...
        <div className="add-package-form">
                ...
                <Form className="form-add-package">
                    {costing.map((cost, index) => {
                        return <Form.Group className="add-package-form-group" controlId="package-cost">
                            ...
                            <Form.Control onChange={(e) => { handleCostingChange(index, e) }} placeholder="Title" className="add-package-form-input" type="text" name="title" value={cost.title} />
                            <br></br>
                            <Form.Control onChange={(e) => { handleCostingChange(index, e) }} placeholder="Cost" className="add-package-form-input" type="text" name="cost" value={cost.cost} />
            ...
            <div className="add-package-form-section">
                <Form className="form-add-package">
                    <Form.Group>
                        <Button className="add-package-button" onClick={addpackage} variant="primary">Add Package</Button>
                    </Form.Group>
                </Form>
            </div>
        </div>
