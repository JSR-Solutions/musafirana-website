                        ...
                        <div className='header-main31'>
                            ...
                            <div className='header-main33'>
                                <ul>
                                    ...
                                    {
                                        !isAuth() &&
                                        <Link className='deconone' to='/sign-up' style={isActive(history, '/sign-us')} onClick={changeScreen}><li>Register</li></Link>
                                    }
                                    {
                                        isAuth() &&
                                        <Link className='deconone' to='/user/dashboard' style={isActive(history, '/user/dashboard')} onClick={changeScreen}><li>{isAuth().FirstName}</li></Link>
                                    }
                                </ul>
                            </div>
                        </div>
